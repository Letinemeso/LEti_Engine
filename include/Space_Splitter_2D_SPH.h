#ifndef __SPACE_SPLITTER_2D_SPH_SPH
#define __SPACE_SPLITTER_2D_SPH_SPH
...
namespace LEti
{
	class Space_Splitter_2D_SPH final		//	TODO: try spatial hashing instead of a quad-tree
	{
	private:
		Space_Splitter_2D_SPH() = delete;
...
#endif // __Space_Splitter_2D_SPH_SPH
