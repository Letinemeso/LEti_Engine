...
namespace LEti
{
	...
	{
	public:
	struct Volumetric_Rectangular_Border
	{
		float left = 0.0f, right = 0.0f, top = 0.0f, bottom = 0.0f, far = 0.0f, close = 0.0f;
	};
	...
	public:
		Volumetric_Rectangular_Border construct_volumetric_rectangular_border() const;
		unsigned int get_pyramids_count() const;
		const Pyramid& operator[](unsigned int _index) const;
